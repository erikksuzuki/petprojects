export const aspectData = [
  ...
  },
  {
    ...
    Square: [
      ...
      [
        "Moon square Jupiter",
        "This aspect causes constantly increasing needs – for emotions, care and comfort. It is not uncommon for people with this aspect to be introverts or to seek intense religious life. Because they are very dependent on external conditions, it is important that they find their purpose in life as early as possible.",
      ],
      [
        "Moon square Saturn",
  ...
  },
  {
    ...
    Square: [
      ...
      [
        "Venus square Mars",
        "People with this aspect can often get offended quite easily and may struggle to balance their emotions – friends can quickly become enemies. In relationships, there is a tendency towards physical gratification, impulsivity or to want impossible things from their partners. When excited however, they are easily filled with enthusiasm.",
      ],
      [
